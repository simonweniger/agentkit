...
html_title = f"python-workflow {release}"
html_logo = "images/python-workflow.png"
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/fgmacedo/python-workflow/",
...
html_context = {
    ...
    "github_repo": "python-workflow",  # Repo name
